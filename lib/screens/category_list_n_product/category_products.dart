...
class _CategoryProductsState extends State<CategoryProducts> {
  ...
  Container buildLoadingContainer() {
    return Container(
      ...
      child: Center(
        child: Text(
          _totalData == _productList.length ? AppLocalizations.of(context).no_more_products_ucf : AppLocalizations.of(context).loading_more_products_ucf,
        ),
      ),
    );
  }
    ...
    return ListView.separated(
      ...
      itemBuilder: (context, index) {
        ...
        if (index == 0 || index == 1) {
          ...
          textColor = MyTheme.font_grey; // Default text color for other containers
        }
