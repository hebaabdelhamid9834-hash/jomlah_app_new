...
import 'package:active_ecommerce_cms_demo_app/custom/category_item_card_widget.dart';
...
class _CategoryListState extends State<CategoryList> {
      ...
      child: Stack(
        children: [
          ...
          Align(
            ...
            child: widget.is_base_category || widget.is_top_category ? Container(height: 0) : buildBottomContainer(),
          ),
        ],
      ),
    );
  ...
  String getAppBarTitle() {
    String name = widget.is_top_category ? AppLocalizations.of(context).top_categories_ucf : AppLocalizations.of(context).categories_ucf;

    return name;
  }

  buildCategoryList() {
    var data = widget.is_top_category ? CategoryRepository().getTopCategories() : CategoryRepository().getCategories(parent_id: widget.slug);
