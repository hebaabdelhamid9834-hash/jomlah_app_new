...
import 'package:active_ecommerce_cms_demo_app/custom/quantity_input.dart';
...
import 'package:active_ecommerce_cms_demo_app/screens/product/product_reviews.dart';
import 'package:active_ecommerce_cms_demo_app/screens/product/widgets/product_slider_image_widget.dart';
import 'package:active_ecommerce_cms_demo_app/screens/product/widgets/tappable_icon_widget.dart';
...
import 'package:active_ecommerce_cms_demo_app/ui_elements/top_selling_products_card.dart';
...
class _ProductDetailsState extends State<ProductDetails> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    // Ensure Android webview implementation is selected on Android
    // try {
  ...
  Future<void> fetchRelatedProducts() async {
    var relatedProductResponse = await ProductRepository().getFrequentlyBoughProducts(slug: widget.slug);
  ...
  Future<void> fetchTopProducts() async {
    var topProductResponse = await ProductRepository().getTopFromThisSellerProducts(slug: widget.slug);
  ...
  Future<void> fetchWishListCheckInfo() async {
    var wishListCheckResponse = await WishListRepository().isProductInUserWishList(product_slug: widget.slug);
  ...
  Future<void> fetchAndSetVariantWiseInfo({bool change_appbar_string = true}) async {
    var colorString = _colorList.isNotEmpty ? _colorList[_selectedColorIndex].toString().replaceAll("#", "") : "";
  ...
  Future<void> addToCart({mode, BuildContext? context, snackbar}) async {
    // if (is_logged_in.$ == false) {
  ...
  Future<void> onPressSendMessage() async {
    ...
    var conversationCreateResponse = await ChatRepository().getCreateConversationResponse(
                          ...
                          child: Row(
                            children: [
                              GestureDetector(
                                ...
                                child: Container(
                                  decoration: BoxDecorations.buildCircularButtonDecoration_for_productDetails(),
                                  width: 36,
                                  height: 36,
                                  child: Center(
                                    child: Icon(
                              ...
                              InkWell(
                                ...
                                child: TappableIconWidget(
                                  icon: Icons.favorite,
                                  color: _isInWishList ? Color.fromRGBO(230, 46, 4, 1) : MyTheme.dark_font_grey,
                                ),
                              ),
                            ],
                          ),
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                if (_productDetails != null && _productDetails!.estShippingTime != null && _productDetails!.estShippingTime! > 0)
                                  _productDetails != null
                                      ? buildShippingTime()
                                      : ShimmerHelper().buildBasicShimmer(
                                          height: 30.0,
                          ...
                          _productDetails != null ? buildSellerRow(context) : ShimmerHelper().buildBasicShimmer(height: 50.0),
                          Padding(
                            ...
                            child: Column(
                              children: [
                                ...
                                _productDetails != null ? buildChoiceOptionList() : buildVariantShimmers(),
    ...
    return Padding(
      ...
      child: InkWell(
        ...
        child: Container(
          decoration: BoxDecoration(
            border: Border.all(
              color: _selectedChoices[choiceOptionsIndex] == option ? MyTheme.accent_color : MyTheme.noColor,
              width: 1.5,
            ),
          ...
          child: Padding(
            ...
            child: Center(
              child: Text(
                option,
                style: TextStyle(
                  color: _selectedChoices[choiceOptionsIndex] == option ? MyTheme.accent_color : Color.fromRGBO(224, 224, 225, 1),
                  fontSize: 12.0,
                  fontWeight: FontWeight.w600,
                ),
              ),
  ...
  Widget buildColorItem(index) {
    return InkWell(
      ...
      child: AnimatedContainer(
        ...
        child: _selectedColorIndex == index ? buildColorCheckerContainer() : Container(height: 25),
      ),
    );
  }
  ...
  AppBar buildAppBar(double statusBarHeight, BuildContext context) {
    return AppBar(
      ...
      title: SizedBox(
        height: kToolbarHeight + statusBarHeight - (MediaQuery.of(context).viewPadding.top > 40 ? 32.0 : 16.0),
      ...
      return BottomAppBar(
        ...
        child: Container(
          ...
          child: Center(
            child: Text(
              "Out of Stock",
              // Using a hardcoded string, but AppLocalizations is better.
      ...
      child: Column(
        ...
        children: [
          ...
          Btn.basic(
            ...
            child: Text(
              webViewHeight == 50 ? LangText(context).local.view_more : LangText(context).local.less,
                    ...
                    return GestureDetector(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          borderRadius: BorderRadius.circular(10),
                          border: Border.all(
                            color: _currentImage == itemIndex ? MyTheme.accent_color : Color.fromRGBO(112, 112, 112, .3),
