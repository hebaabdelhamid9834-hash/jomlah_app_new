...
class _ProductReviewsState extends State<ProductReviews> {
  ...
  onTapReviewSubmit(context) async {
    ...
    if (is_logged_in.$ == false) {
      print("sending rate not logged in");
    ...
    if (reviewSubmitResponse.result == false) {
      // print("error ${reviewSubmitResponse.message}");
      showDialog(
        context: context,
        builder: (BuildContext context) {
          return AlertDialog(
            content:  Column(
              ...
              children: [
                Text(reviewSubmitResponse.message),
              ],
            ),
          );
        },
    ...
    print("success ${reviewSubmitResponse.message}");
  ...
  Container buildLoadingContainer() {
    return Container(
      ...
      child: Center(
        child: Text(
          _totalData == _reviewList.length ? AppLocalizations.of(context).no_more_reviews_ucf : AppLocalizations.of(context).loading_more_reviews_ucf,
        ),
      ),
    );
  }
