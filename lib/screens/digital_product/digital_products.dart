...
class _DigitalProductsState extends State<DigitalProducts> {
  ...
  Container buildLoadingContainer() {
    return Container(
      ...
      child: Center(
        child: Text(
          _totalData == _digitalProducts.length ? AppLocalizations.of(context).no_more_products_ucf : AppLocalizations.of(context).loading_more_products_ucf,
        ),
      ),
    );
  }
    ...
    return InkWell(
      onTap: () {
        Navigator.push(
          ...
          MaterialPageRoute(
            builder: (context) {
              return widget.identifier == 'auction' ? AuctionProductsDetails(slug: widget.slug) : DigitalProductDetails(slug: widget.slug);
            },
          ),
        );
      },
