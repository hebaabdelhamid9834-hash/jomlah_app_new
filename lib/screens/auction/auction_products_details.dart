...
class _AuctionProductsDetailsState extends State<AuctionProductsDetails> with TickerProviderStateMixin {
  ...
  fetchAuctionProductDetails() async {
    var auctionproductDetailsResponse = await AuctionProductsRepository().getAuctionProductsDetails(widget.slug);
    ...
    if (auctionproductDetailsResponse.auctionProduct!.isNotEmpty) {
      ...
      sellerChatTitleController.text = auctionproductDetailsResponse.auctionProduct![0].name!;
    }
            ...
            ? Container(
                ...
                child: InkWell(
                  ...
                  child: Container(
                    ...
                    child: Center(
                      child: Text(
                        (_auctionproductDetails.highestBid == '' || _auctionproductDetails.highestBid == null) ? AppLocalizations.of(context).place_bid_ucf : AppLocalizations.of(context).change_bid_ucf,
                        style: TextStyle(
                          color: Colors.white,
                          fontSize: 16,
                          fontWeight: FontWeight.w600,
                          ...
                          MaterialPageRoute(
                            builder: (context) {
                              return CommonWebviewScreen(
                                url: "${AppConfig.RAW_BASE_URL}/mobile-page/seller-policy",
                      ...
                      onTap: () {
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) {
                              return CommonWebviewScreen(
                                url: "${AppConfig.RAW_BASE_URL}/mobile-page/return-policy",
                                page_name: AppLocalizations.of(
                                  context,
                                )!
                                    .return_policy_ucf,
                      ...
                      onTap: () {
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) {
                              return CommonWebviewScreen(
                                url: "${AppConfig.RAW_BASE_URL}/mobile-page/support-policy",
                                page_name: AppLocalizations.of(
                                  context,
                                )!
                                    .support_policy_ucf,
                    ...
                    TextFormField(
                      ...
                      validator: (value) {
                        ...
                        if (_auctionproductDetails.highestBid != '') {
                          if (double.parse(value) < _auctionproductDetails.minBidPrice.toDouble()) {
                            return AppLocalizations.of(
                              context,
                            )!
  ...
  Widget buildAuctionHighestBidRow() {
    return Row(
      children: [
        ...
        Padding(
          padding: const EdgeInsets.symmetric(horizontal: 8.0),
          child: _auctionproductDetails.highestBid != '' ? Text(convertPrice(_auctionproductDetails.highestBid)) : Text(''),
        ),
      ],
    );
  }
        ...
        Padding(
          ...
          child: SizedBox(
            ...
            child: CountdownTimer(
              ...
              endTime: DateTime.now().day + (1000 * _auctionproductDetails.auctionEndDate as int),
  ...
  buildBrandRow() {
    return (_auctionproductDetails.brand?.id != null && _auctionproductDetails.brand!.id! > 0)
        ? InkWell(
            onTap: () {
              Navigator.push(
                context,
              ...
              children: <Widget>[
                Builder(
                  builder: (context) {
                    ...
                    return Btn.basic(
                      child: Text(
                        !controller.expanded ? AppLocalizations.of(context).view_more : AppLocalizations.of(context).show_less_ucf,
                        style: TextStyle(
                          color: MyTheme.font_grey,
                          fontSize: 11,
                        ),
                        ...
                        children: List.generate(
                          ...
                          (index) => Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              color: _currentImage == index ? MyTheme.font_grey : Colors.grey.withOpacity(0.2),
                            ),
                          ),
                        ),
                      ),
