...
import 'package:active_ecommerce_cms_demo_app/data_model/auction_bidded_products.dart';
...
class _AuctionBiddedProductsState extends State<AuctionBiddedProducts> {
  ...
  getBiddedList() async {
    var biddedResponse = await AuctionProductsRepository().getAuctionBiddedProducts(page: _page);
                          ...
                          Padding(
                            ...
                            child: TextButton(
                              style: TextButton.styleFrom(
                                ...
                                backgroundColor: isBuyable! ? MyTheme.accent_color : MyTheme.noColor,
                              ...
                              child: Text(
                                ...
                                style: TextStyle(
                                  fontSize: 12,
                                  color: isBuyable ? MyTheme.white : MyTheme.accent_color,
                                ),
                              ),
                              onPressed: () {
                                if (isBuyable) {
