...
class _AuctionProductsState extends State<AuctionProducts> {
  ...
  fetchData() async {
    var auctionProductResponse = await AuctionProductsRepository().getAuctionProducts(page: _page);
  ...
  Container buildLoadingContainer() {
    return Container(
      ...
      child: Center(
        child: Text(
          _totalData == _auctionProductItems.length ? AppLocalizations.of(context).no_more_products_ucf : AppLocalizations.of(context).loading_more_products_ucf,
        ),
      ),
    );
  }
