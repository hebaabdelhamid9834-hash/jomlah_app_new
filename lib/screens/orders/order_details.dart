...
class _OrderDetailsState extends State<OrderDetails> {
  ...
  onPressSubmitRefund(itemId, setState) async {
    ...
    var refundRequestSendResponse = await RefundRequestRepository().getRefundRequestSendResponse(id: itemId, reason: reason);
              ...
              slivers: [
                SliverToBoxAdapter(
                  child: Padding(
                    ...
                    child: _orderDetails != null ? buildTimeLineTiles() : buildTimeLineShimmer(),
                  ),
                ),
                SliverList(
      ...
      child: Column(
        ...
        children: [
          TimelineTile(
            ...
            afterLineStyle: _stepIndex >= 1 ? LineStyle(color: Colors.green, thickness: 5) : LineStyle(color: MyTheme.medium_grey, thickness: 4),
          ),
          TimelineTile(
            axis: TimelineAxis.vertical,
            alignment: TimelineAlign.end,
            ...
            beforeLineStyle: _stepIndex >= 1 ? LineStyle(color: Colors.green, thickness: 5) : LineStyle(color: MyTheme.medium_grey, thickness: 4),
            afterLineStyle: _stepIndex >= 2 ? LineStyle(color: Colors.green, thickness: 5) : LineStyle(color: MyTheme.medium_grey, thickness: 4),
          ),
          TimelineTile(
            axis: TimelineAxis.vertical,
            alignment: TimelineAlign.end,
            ...
            beforeLineStyle: _stepIndex >= 2 ? LineStyle(color: Colors.green, thickness: 5) : LineStyle(color: MyTheme.medium_grey, thickness: 4),
            afterLineStyle: _stepIndex >= 5 ? LineStyle(color: Colors.green, thickness: 5) : LineStyle(color: MyTheme.medium_grey, thickness: 4),
          ),
          TimelineTile(
            axis: TimelineAxis.vertical,
            alignment: TimelineAlign.end,
            ...
            beforeLineStyle: _stepIndex >= 5 ? LineStyle(color: Colors.green, thickness: 5) : LineStyle(color: MyTheme.medium_grey, thickness: 4),
          ),
        ],
      ),
    );
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                Text(
                  _orderDetails!.shipping_address != null ? AppLocalizations.of(context).shipping_address_ucf : AppLocalizations.of(context).pickup_point_ucf,
                  style: TextStyle(
                    color: MyTheme.font_grey,
                    fontSize: 13,
                    fontWeight: FontWeight.w600,
            ...
            if (_orderDetails!.delivery_status == "pending" && _orderDetails!.payment_status == "unpaid")
              Btn.basic(
                shape: RoundedRectangleBorder(
                  borderRadius: BorderRadius.circular(8),
                ),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _orderedItemList[index].refund_section && _orderedItemList[index].refund_button
                ? InkWell(
                    onTap: () {
                      onTapAskRefund(
                ...
                : Container(),
            _orderedItemList[index].refund_section && _orderedItemList[index].refund_label != ""
                ? Row(
                    mainAxisAlignment: MainAxisAlignment.end,
                    children: [
                      Column(
    ...
    return Container(
      ...
      child: SingleChildScrollView(
        child: ListView.separated(
          separatorBuilder: (context, index) => Divider(color: MyTheme.medium_grey),
