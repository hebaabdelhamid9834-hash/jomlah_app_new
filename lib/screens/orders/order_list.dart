...
class _OrderListState extends State<OrderList> {
  ...
  Container buildLoadingContainer() {
    return Container(
      ...
      child: Center(
        child: Text(
          _totalData == _orderList.length ? AppLocalizations.of(context).no_more_orders_ucf : AppLocalizations.of(context).loading_more_orders_ucf,
        ),
      ),
    );
  }
          ...
          Expanded(
            child: Container(
              ...
              child: DropdownButton<PaymentStatus>(
                ...
                isExpanded: true, // ✅ Important: makes dropdown use full width
          ...
          Expanded(
            child: Container(
              ...
              child: DropdownButton<DeliveryStatus>(
                ...
                iconSize: 14,
                underline: const SizedBox(),
                isExpanded: true, // ✅ Make it expand to container width
