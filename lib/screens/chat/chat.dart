...
class _ChatState extends State<Chat> {
  ...
  Container buildLoadingContainer() {
    return Container(
      ...
      child: Center(
        child: Text(
          _totalData == _list.length ? AppLocalizations.of(context).no_more_items_ucf : AppLocalizations.of(context).loading_more_items_ucf,
        ),
      ),
    );
  }
            ...
            return Container(
              ...
              child: Column(
                children: [
                  ...
                  Align(
                    alignment: (_list[index].sendType == "customer" ? Alignment.topRight : Alignment.topLeft),
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.only(
          ...
          bottomLeft: _list[index].sendType == "customer" ? Radius.circular(16) : Radius.circular(0),
          bottomRight: _list[index].sendType == "customer" ? Radius.circular(0) : Radius.circular(16),
        ),
        color: (_list[index].sendType == "customer" ? const Color(0xffE62E04) : Colors.white),
        boxShadow: [
          BoxShadow(
        ...
        children: [
          Positioned(
            ...
            child: Text(
              ...
              style: TextStyle(
                fontSize: 8,
                color: (_list[index].sendType == "customer" ? MyTheme.light_grey : const Color(0xff707070)),
              ),
            ),
          ),
          Padding(
            ...
            child: Text(
              ...
              style: TextStyle(
                fontSize: 12,
                color: (_list[index].sendType == "customer" ? MyTheme.white : Colors.black),
              ),
            ),
          ),
        ],
