...
import 'package:active_ecommerce_cms_demo_app/custom/my_separator.dart';
...
import 'package:active_ecommerce_cms_demo_app/screens/coupon/coupon_products.dart';
...
class _CouponsState extends State<Coupons> {
  ...
  Container buildLoadingContainer() {
    return Container(
      ...
      child: Center(
        child: Text(
          _totalData == _couponsList.length ? AppLocalizations.of(context).no_more_coupons_ucf : AppLocalizations.of(context).loading_coupons_ucf,
        ),
      ),
    );
  }
  ...
  Widget buildCouponHeader(int index) {
    return Column(
      ...
      children: [
        ...
        SizedBox(height: 5),
        Text(
          _couponsList[index].discountType == "percent" ? "${_couponsList[index].discount}% ${LangText(context).local.off}" : "${convertPrice(_couponsList[index].discount.toString())} ${LangText(context).local.off}",
          style: TextStyle(
            color: Colors.white,
            fontSize: 21,
            fontWeight: FontWeight.bold,
