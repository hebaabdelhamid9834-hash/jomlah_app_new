...
class _SearchWidgetState extends State<SearchWidget> {
  ...
  Container buildProductLoadingContainer() {
    return Container(
      ...
      child: Center(
        child: Text(
          _totalProductData == _productList.length ? AppLocalizations.of(context).no_more_products_ucf : AppLocalizations.of(context).loading_more_products_ucf,
        ),
      ),
    );
  }
  ...
  Container buildBrandLoadingContainer() {
    return Container(
      ...
      child: Center(
        child: Text(
          _totalBrandData == _brandList.length ? AppLocalizations.of(context).no_more_brands_ucf : AppLocalizations.of(context).loading_more_brands_ucf,
        ),
      ),
    );
  }
  ...
  Container buildShopLoadingContainer() {
    return Container(
      ...
      child: Center(
        child: Text(
          _totalShopData == _shopList.length ? AppLocalizations.of(context).no_more_shops_ucf : AppLocalizations.of(context).loading_more_shops_ucf,
        ),
      ),
    );
  }
        ...
        body: Stack(
          ...
          children: [
            ...
            Align(
              ...
              child: _selectedFilter!.option_key == 'product' ? buildProductLoadingContainer() : (_selectedFilter!.option_key == 'brands' ? buildBrandLoadingContainer() : buildShopLoadingContainer()),
            ),
          ],
        ),
      ),
                ...
                itemBuilder: (context, dynamic suggestion) {
                  ...
                  return ListTile(
                    ...
                    title: Text(
                      suggestion.query,
                      style: TextStyle(
                        color: suggestion.type != "search" ? MyTheme.accent_color : MyTheme.font_grey,
                      ),
                    ),
                    subtitle: Text(
                      subtitle,
                      style: TextStyle(
                        color: suggestion.type != "search" ? MyTheme.font_grey : MyTheme.medium_grey,
                      ),
                    ),
                  );
                },
