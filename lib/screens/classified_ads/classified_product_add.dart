...
import 'package:active_ecommerce_cms_demo_app/custom/aiz_summer_note.dart';
...
class _ClassifiedProductAddState extends State<ClassifiedProductAdd> {
  ...
  // Controllers
  final TextEditingController productNameEditTextController = TextEditingController();
  ...
  final TextEditingController metaDescriptionEditTextController = TextEditingController();
  final TextEditingController videoLinkController = TextEditingController();
  final TextEditingController unitPriceEditTextController = TextEditingController(text: "0");
  ...
  String? productName, brandId, categoryId, unit, conditon, location, photos, thumbnailImg, videoProvider, videoLink, unitPrice, externalLink, pdf, metaTitle, metaDescription, metaImg;
  ...
  Future<void> submit() async {
    ...
    var response = await ClassifiedProductRepository().addProductResponse(postBody);
            ...
            children: [
              Row(
                ...
                children: [
                  ...
                  Icon(
                    _generalExpanded ? Icons.keyboard_arrow_down : Icons.navigate_next_rounded,
                    size: 20,
                    color: MyTheme.dark_font_grey,
                  ),
                ],
                      ...
                      Focus(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            color: MyTheme.white,
                            border: Border.all(
                              color: _hasFocus ? MyTheme.textfield_grey : MyTheme.accent_color,
            ...
            children: [
              Row(
                ...
                children: [
                  ...
                  Icon(
                    _mediaExpanded ? Icons.keyboard_arrow_down : Icons.navigate_next_rounded,
                    size: 20,
                    color: MyTheme.dark_font_grey,
                  ),
                ],
    ...
    return Column(
      ...
      children: [
        TextButton(
          ...
          onPressed: () async {
            String purpose = "To upload your PDF specification, this app needs to access your documents.";
            ...
            List<FileInfo> chooseFile = await (Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => UploadFile(fileType: fileType, canSelect: true),
              ),
            ));
    ...
    return Column(
      ...
      children: [
        TextButton(
          style: TextButton.styleFrom(padding: EdgeInsets.zero),
          onPressed: () async {
            String purpose = "To upload a product image, this app needs to access your gallery.";
            bool userAgreed = await _showDisclosureDialog(purpose);
            ...
            List<FileInfo> chooseFile = await (Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => const UploadFile(fileType: "image", canSelect: true),
              ),
            ));
            ...
            children: [
              Row(
                ...
                children: [
                  ...
                  Icon(
                    _priceExpanded ? Icons.keyboard_arrow_down : Icons.navigate_next_rounded,
                    size: 20,
                    color: MyTheme.dark_font_grey,
                  ),
                ],
                ...
                child: SizedBox(
                  ...
                  child: Column(
                    ...
                    children: [
                      buildEditTextField(
                        AppLocalizations.of(context).auction_price_ucf,
                        LangText(context).local.custom_unit_price_and_base_price,
                        ...
                        Container(
                          ...
                          child: TextField(
                            ...
                            decoration: InputDecoration.collapsed(
                              hintText: LangText(context).local.meta_description_ucf,
                            ),
                          ),
                        ),
                      ),
        ...
        child: Wrap(
          ...
          children: List.generate(tags.length + 1, (index) {
            if (index == tags.length) {
              return TextField(
                onSubmitted: (string) {
                  var tag = textEditingController.text.trim().replaceAll(",", "").toString();
                ...
                decoration: InputDecoration(
                  ...
                  hintText: AppLocalizations.of(context).type_and_hit_submit_ucf,
  ...
  pickGalleryImages() async {
    String purpose = "To upload product gallery images, this app needs to access your photos.";
    bool userAgreed = await _showDisclosureDialog(purpose);
