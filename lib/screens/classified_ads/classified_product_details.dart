...
class _ClassifiedAdsDetailsState extends State<ClassifiedAdsDetails> with TickerProviderStateMixin {
  ...
  fetchProductDetails() async {
    var productDetailsResponse = await ClassifiedProductRepository().getClassifiedProductsDetails(widget.slug);
  ...
  fetchRelatedProducts() async {
    var relatedProductResponse = await ClassifiedProductRepository().getClassifiedOtherAds(slug: widget.slug);
