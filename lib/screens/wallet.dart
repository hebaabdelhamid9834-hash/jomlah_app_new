...
class _WalletState extends State<Wallet> {
              ...
              children: [
                Container(
                  ...
                  child: Padding(
                    ...
                    child: _balanceDetails != null ? buildTopSection(context) : ShimmerHelper().buildBasicShimmer(height: 150),
                  ),
                ),
                Padding(
  ...
  Container buildLoadingContainer() {
    return Container(
      ...
      child: Center(
        child: Text(
          _totalRechargeData == _rechargeList.length ? AppLocalizations.of(context).no_more_histories_ucf : AppLocalizations.of(context).loading_more_histories_ucf,
        ),
      ),
    );
  }
