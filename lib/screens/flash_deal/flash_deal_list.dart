      ...
      child: Row(
        ...
        children: [
          ...
          ClipRRect(
            ...
            child: SizedBox(
              ...
              child: FadeInImage(
                ...
                image: NetworkImage(
                  flashDealResponse.flashDeals[flashDealIndex].products.products[productIndex].image,
                ),
          ...
          Padding(
            ...
            child: Text(
              convertPrice(
                flashDealResponse.flashDeals[flashDealIndex].products.products[productIndex].price,
              ),
              style: TextStyle(
                fontSize: 13,
                color: MyTheme.accent_color,
  ...
  AppBar buildAppBar(BuildContext context) {
    return AppBar(
      ...
      leading: IconButton(
        ...
        icon: Icon(
          app_language_rtl.$! ? Icons.arrow_forward : Icons.arrow_back,
