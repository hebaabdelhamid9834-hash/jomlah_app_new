      ...
      child: Directionality(
        ...
        child: Scaffold(
          ...
          bottomNavigationBar: Builder(
            builder: (context) {
              // Respect system bottom inset so the nav bar is not hidden by system navigation
                  ...
                  items: [
                    BottomNavigationBarItem(
                      icon: Padding(
                        ...
                        child: Image.asset(
                          "assets/home.png",
                          color: _currentIndex == 0 ? MyTheme.accent_color : Color.fromRGBO(153, 153, 153, 1),
                          height: 20,
                        ),
                      ),
                    ...
                    BottomNavigationBarItem(
                      icon: Padding(
                        ...
                        child: Image.asset(
                          ...
                          color: _currentIndex == 1 ? MyTheme.accent_color : Color.fromRGBO(153, 153, 153, 1),
                          height: 20,
                        ),
                      ),
                    ...
                    BottomNavigationBarItem(
                      icon: Padding(
                        ...
                        child: badges.Badge(
                          ...
                          child: Image.asset(
                            "assets/cart.png",
                            color: _currentIndex == 2 ? MyTheme.accent_color : Color.fromRGBO(153, 153, 153, 1),
                            height: 20,
                          ),
                        ),
                      ),
                    ...
                    BottomNavigationBarItem(
                      icon: Padding(
                        ...
                        child: Image.asset(
                          "assets/profile.png",
                          color: _currentIndex == 3 ? MyTheme.accent_color : Color.fromRGBO(153, 153, 153, 1),
                          height: 20,
                        ),
                      ),
