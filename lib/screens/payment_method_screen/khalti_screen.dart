...
class _KhaltiScreenState extends State<KhaltiScreen> {
  ...
  khalti() {
    String initialUrl = "${AppConfig.BASE_URL}/khalti/payment/pay?payment_type=${widget.payment_type}&combined_order_id=$_combined_order_id&amount=${widget.amount}&user_id=${user_id.$}&package_id=${widget.package_id}&order_id=${widget.orderId}";
  ...
  checkPhoneAvailability() async {
    var phoneEmailAvailabilityResponse = await ProfileRepository().getPhoneEmailAvailabilityResponse();
