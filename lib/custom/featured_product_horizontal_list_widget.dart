...
class FeaturedProductHorizontalListWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    if (homeData.isFeaturedProductInitial == true && homeData.featuredProductList.isEmpty) {
      return Row(
        children: [
          Expanded(
            child: Padding(
        ...
        child: SizedBox(
          ...
          child: NotificationListener<ScrollNotification>(
            ...
            child: ListView.separated(
              ...
              itemCount: homeData.totalFeaturedProductData! > homeData.featuredProductList.length ? homeData.featuredProductList.length + 1 : homeData.featuredProductList.length,
              ...
              itemBuilder: (context, index) {
                return (index == homeData.featuredProductList.length)
                    ...
                    : MiniProductCard(
                        ...
                        image: homeData.featuredProductList[index].thumbnail_image,
                        name: homeData.featuredProductList[index].name,
                        main_price: homeData.featuredProductList[index].main_price,
                        stroked_price: homeData.featuredProductList[index].stroked_price,
                        has_discount: homeData.featuredProductList[index].has_discount,
                        is_wholesale: homeData.featuredProductList[index].isWholesale,
